...
/**
 * Simple extension of {@link cn.com.pencho.storm.rabbitmq.RabbitMQBolt} that provides the ability to determine whether a message should be published
 * based on the input tuple
 * This class is sort of an SPI meaning that it is meant to be subclassed
 * and the method {@link cn.com.pencho.storm.rabbitmq.ConditionalPublishingRabbitMQBolt#shouldPublish}
