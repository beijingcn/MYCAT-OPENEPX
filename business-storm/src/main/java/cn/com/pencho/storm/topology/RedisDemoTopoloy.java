...
import cn.com.pencho.storm.bolt.PrintWordTotalCountBolt;
import cn.com.pencho.storm.bolt.SplitSentence;
import cn.com.pencho.storm.bolt.WordCount;
import cn.com.pencho.storm.mapper.WordCountRedisLookupMapper;
import cn.com.pencho.storm.mapper.WordCountRedisStoreMapper;
import cn.com.pencho.storm.spout.RandomSentenceSpout;
 ...
 * 测试 Redis 存储 查询
 * bin/storm jar examples/business-storm-1.0-SNAPSHOT-all.jar cn.com.pencho.storm.topology.RedisDemoTopoloy 192.168.0.224 6379 redis_demo
 */
